...
#     print("{:20}: {:3d}".format('Not-a Dog Images', results_stats_dic['n_notdogs_img']))
    dog_data=[['# N Images', results_stats_dic['n_images']], 
              ['# N Dog Images', results_stats_dic['n_dogs_img']],
              ['# Not-a Dog Images', results_stats_dic['n_notdogs_img']]
              ]
    print(tabulate(dog_data, tablefmt="fancy_grid"))
#     print(f'\n\n *** Results of CNN Model Architecture {model} *** \n\n')
...
#     print(f'% Match Labels: {results_stats_dic["pct_match"]}')
    ...
    headers=["CNN Model Architecture", "% Not-a-Dog Correct", "% Dogs Correct", "% Breeds Correct", "% Match Labels"]
    percent_data=[
                [model.upper(), results_stats_dic["pct_correct_notdogs"], results_stats_dic["pct_correct_dogs"], results_stats_dic["pct_correct_breed"], results_stats_dic["pct_match"]]
                ]
    print(tabulate(percent_data, headers=headers, tablefmt="fancy_grid"))
    ...
    if (print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed'])):
           ...
           for key in results_dic:
               ...
               if (sum(results_dic[key][3:]) == 2 and results_dic[key][2] == 0):
                   print("Pet_label: {:>5}   Classifier_label: {:>30}".format(results_dic[key][0],results_dic[key][1]))